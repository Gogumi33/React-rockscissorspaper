  ...
  render() {
    return (
        ...
        <div className="buttons">
          <button onClick={() => this.play("rock")}><img src="image/rock.png" class="imgs" alt=""/></button>
          <button onClick={() => this.play("scissors")}><img src="image/scissors.png" class="imgs" alt=""/></button>
          <button onClick={() => this.play("paper")}><img src="image/paper.png" class="imgs" alt=""/></button>
        </div>
      </div>
    )
  }
